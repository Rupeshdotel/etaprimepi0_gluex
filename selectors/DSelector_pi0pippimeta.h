#ifndef DSelector_pi0pippimeta_h
#define DSelector_pi0pippimeta_h
...
class DSelector_pi0pippimeta : public DSelector
{
	public:

		DSelector_pi0pippimeta(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_pi0pippimeta(){}
	...
	ClassDef(DSelector_pi0pippimeta, 0);
};

void DSelector_pi0pippimeta::Get_ComboWrappers(void)
{
	//Step 0
...
#endif // DSelector_pi0pippimeta_h
