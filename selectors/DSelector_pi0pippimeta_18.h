#ifndef DSelector_pi0pippimeta_18_h
#define DSelector_pi0pippimeta_18_h
...
class DSelector_pi0pippimeta_18 : public DSelector
{
	public:

		DSelector_pi0pippimeta_18(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_pi0pippimeta_18(){}
	...
	ClassDef(DSelector_pi0pippimeta_18, 0);
};

void DSelector_pi0pippimeta_18::Get_ComboWrappers(void)
{
	//Step 0
...
#endif // DSelector_pi0pippimeta_18_h
